...
export default function FairTradePage() {
  return (
    <div className="flex flex-col bg-white">
      ...
      {/* 2. EDITORIAL HERO */}
      <section className="mx-auto w-full max-w-[1400px] 2xl:max-w-[1600px] px-6 lg:px-8 2xl:px-12 pt-3 pb-10 lg:pb-14">
        <div className="grid grid-cols-1 lg:grid-cols-[1.25fr_1fr] gap-10 lg:gap-14 xl:gap-20 items-center">
          ...
          <FadeIn duration={600} translateY={16} className="flex flex-col">
            ...
            <p className="text-[16.5px] sm:text-[18px] 2xl:text-[19.5px] text-[#4A5568] leading-relaxed max-w-xl">
          ...
          <FadeIn delay={120} duration={600} translateY={16} className="relative">
            <div className="relative aspect-[4/5] sm:aspect-[16/11] lg:aspect-[4/5] max-h-[400px] 2xl:max-h-[460px] w-full rounded-sm overflow-hidden bg-[#EFECE6] border border-[#E5E2DC] shadow-[0_16px_40px_rgba(0,0,0,0.04)]">
              <Image
        ...
        <div className="mx-auto max-w-[1400px] 2xl:max-w-[1600px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col border-t border-[#E5E2DC] pt-5">
              <span className="text-[12px] font-mono font-bold text-[#C01718] mb-2 select-none">
                01
              </span>
              <h3 className="font-display text-xl sm:text-2xl text-[#1A1A1A] mb-2 leading-snug">
      ...
      <section className="py-12 lg:py-16 px-6 lg:px-8 2xl:px-12 bg-white">
        <div className="mx-auto max-w-[1400px] 2xl:max-w-[1600px]">
          ...
          <div className="mb-10 lg:mb-12">
            ...
            <h2 className="font-display text-3xl sm:text-4xl lg:text-[38px] font-normal text-[#1A1A1A] tracking-tight mb-2.5">
          ...
          {/* GOTS & Fair Wear Editorial 2-Column Comparison */}
          ...
          {/* Compact Brand Bridge (Replacing the entire Brand grid) */}
          <div className="mt-10 pt-6 border-t border-[#EDEAE4] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <p className="text-[14.5px] text-[#5A6578]">
      ...
      <section className="bg-[#FAF9F6] border-y border-[#EDEAE4] py-12 lg:py-16 px-6 lg:px-8 2xl:px-12">
        <div className="mx-auto max-w-[1400px] 2xl:max-w-[1600px]">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-10 lg:gap-14 xl:gap-20 items-center">
            ...
            <div className="relative aspect-[4/3] sm:aspect-[16/11] lg:aspect-[4/3] max-h-[380px] 2xl:max-h-[420px] w-full rounded-sm overflow-hidden bg-[#EFECE6] border border-[#E5E2DC] shadow-[0_16px_40px_rgba(0,0,0,0.04)]">
              <Image
            ...
            <div className="flex flex-col">
              ...
              <h2 className="font-display text-3xl sm:text-4xl lg:text-[40px] font-normal text-[#1A1A1A] mb-3.5 tracking-tight leading-snug">
                Gut beraten statt beliebig gekauft.
              </h2>
              <p className="text-[15px] sm:text-[16.5px] text-[#4A5568] leading-relaxed mb-6 max-w-xl">
      ...
      <section className="py-12 lg:py-16 px-6 lg:px-8 2xl:px-12 bg-white text-center">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="text-[15.5px] sm:text-[16.5px] text-[#4A5568] leading-relaxed max-w-xl mx-auto mb-6">
