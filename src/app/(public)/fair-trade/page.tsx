  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      <section className="mx-auto w-full max-w-[1400px] 2xl:max-w-[1600px] px-6 lg:px-8 2xl:px-12 pt-2 sm:pt-3 pb-8 sm:pb-10 lg:pb-14">
        <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-6 sm:gap-10 lg:gap-12 xl:gap-16 items-center">
          
          {/* Left: Heading & Intro */}
          <FadeIn className="flex flex-col lg:pb-3">
            ...
            <h1 className="font-display text-3xl sm:text-5xl lg:text-[44px] 2xl:text-[52px] font-normal leading-[1.08] tracking-tight text-[#1A1A1A] mb-3 sm:mb-4">
          ...
          <FadeIn className="relative">
            <div className="relative aspect-[4/3] sm:aspect-[16/11] lg:aspect-[3/2] max-h-[300px] sm:max-h-[380px] 2xl:max-h-[420px] w-full rounded-sm overflow-hidden bg-[#EFECE6] border border-[#E5E2DC] shadow-[0_12px_32px_rgba(0,0,0,0.03)]">
              <Image
