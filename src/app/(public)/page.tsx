  ...
  return (
    <>
      ...
      <div className="flex flex-col bg-[#F9F9F8]">
        ...
        <section className="relative w-full overflow-hidden bg-[#F9F9F8] pt-2 sm:pt-4 lg:pt-14 xl:pt-16 2xl:pt-20 pb-8 sm:pb-10 lg:pb-16 xl:pb-20 2xl:pb-24 min-h-0 lg:min-h-[calc(84vh-80px)] 2xl:min-h-[calc(86vh-80px)] flex flex-col justify-between">
          
          {/* ============================================================ */}
          {/* DESKTOP HERO PRESENTATION (>= 1024px) — STRICTLY FROZEN     */}
          {/* ============================================================ */}
          ...
          <div className="hidden lg:flex mx-auto w-full max-w-[1400px] 2xl:max-w-[1600px] px-8 2xl:px-12 relative z-10 flex-1 flex-col justify-center">
            <div className="w-full lg:w-[53%] xl:w-[50%] 2xl:w-[48%]">
              <FadeIn duration={600} translateY={16} className="flex flex-col items-start">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-[13px] 2xl:text-[14px] font-semibold uppercase tracking-[0.14em] 2xl:tracking-[0.16em] text-[#C01718]">
          ...
          {/* ============================================================ */}
          {/* MOBILE & TABLET HERO (< 1024px) — IMAGE-LED WOW PASS         */}
          {/* ============================================================ */}
          <div className="block lg:hidden w-full px-4 sm:px-6">
            ...
            {/* Overlapping Editorial Typography Panel */}
            <div className="relative z-10 -mt-10 sm:-mt-12 mx-1.5 sm:mx-3 bg-white border border-[#EDEAE4] rounded-sm p-5 sm:p-7 shadow-[0_6px_20px_rgba(0,0,0,0.03)] flex flex-col items-start">
              {/* Eyebrow */}
              <div className="flex items-center gap-2.5 mb-2.5">
                <span className="w-5 h-[2px] bg-[#C01718]" aria-hidden="true" />
                <span className="text-[11.5px] sm:text-[12.5px] font-semibold uppercase tracking-[0.14em] text-[#C01718]">
                  Boutique in Wien-Hietzing
                </span>
              </div>
              ...
              {/* Supporting Copy */}
              <p className="mb-5 sm:mb-6 text-[15px] sm:text-[16.5px] leading-relaxed text-[#4A5568]">
                Ausgewählte Damenmode für Frauen, die ihren eigenen Stil tragen möchten – mit ehrlicher Beratung direkt in Wien-Hietzing.
              </p>

              {/* Actions: Primary Full-Width Red Button + Centered Secondary Link */}
              <div className="flex flex-col gap-3.5 w-full">
                <Link
                  href="#discovery"
                  className="inline-flex items-center justify-center rounded-sm bg-[#C01718] px-7 py-3.5 text-[12.5px] sm:text-[13px] font-medium uppercase tracking-[0.08em] text-white !text-white transition-colors duration-200 ease-out hover:bg-[#A01314] hover:text-white hover:!text-white focus:outline-hidden focus-visible:ring-2 focus-visible:ring-[#C01718] focus-visible:ring-offset-2 w-full text-center min-h-[48px]"
                >
                  <span className="text-white font-medium">Kollektion entdecken</span>
                </Link>
                <Link
                  href="/kontakt"
                  className="group inline-flex items-center justify-center text-[12.5px] font-medium uppercase tracking-[0.08em] text-[#1A1A1A] hover:text-[#C01718] transition-colors border-b border-[#1A1A1A]/35 hover:border-[#C01718] pb-0.5 self-center focus:outline-hidden focus-visible:ring-2 focus-visible:ring-[#C01718] focus-visible:ring-offset-2"
                >
                  Besuchen Sie uns <span className="ml-1.5 inline-block transition-transform duration-200 group-hover:translate-x-1" aria-hidden="true">→</span>
                </Link>
              </div>
        ...
        <section className="bg-[#FAF9F6] border-b border-[#EDEAE4] px-6 lg:px-8 2xl:px-12 py-10 sm:py-16 lg:py-20 xl:py-24 2xl:py-28">
          <div className="mx-auto max-w-[1400px] 2xl:max-w-[1600px]">
            <div className="flex flex-col lg:flex-row items-center justify-center gap-4 sm:gap-8 lg:gap-0 relative">
              ...
              <div className="w-full max-w-[340px] sm:max-w-[440px] lg:max-w-none lg:w-[40%] xl:w-[38%] 2xl:w-[37%] shrink-0">
                <FadeIn duration={600} translateY={16} className="relative aspect-[4/5] sm:aspect-[3.7/5] xl:aspect-[3.6/5] w-full max-h-[420px] sm:max-h-[520px] lg:max-h-[580px] 2xl:max-h-[660px] overflow-hidden rounded-sm bg-[#EFECE6] shadow-[0_8px_24px_rgba(0,0,0,0.03)] lg:shadow-[0_12px_32px_rgba(0,0,0,0.04)]">
                  <Image
              ...
              <div className="w-full max-w-[580px] lg:max-w-none lg:w-[56%] xl:w-[58%] 2xl:w-[57%] lg:-ml-14 xl:-ml-18 2xl:-ml-20 relative z-10">
                <FadeIn delay={120} duration={600} translateY={16} className="bg-transparent lg:bg-white border-0 lg:border lg:border-[#E5E2DC] rounded-none lg:rounded-sm p-2 sm:p-6 lg:p-9 xl:p-11 2xl:p-13 shadow-none lg:shadow-[0_10px_30px_rgba(0,0,0,0.03)] relative">
                  {/* Subtle pale red typographic quote accent (desktop only) */}
                  <span
                    className="hidden lg:block select-none pointer-events-none absolute -top-4 sm:-top-5 -left-2 sm:-left-3 font-serif text-[100px] 2xl:text-[120px] leading-none text-[#C01718]/10"
                    aria-hidden="true"
                  >
                    „
                  </span>
                  ...
                  {/* Eyebrow */}
                  <div className="flex items-center gap-2.5 mb-2 sm:mb-3.5 relative z-10">
                    <span className="w-5 h-[2px] bg-[#C01718]" aria-hidden="true" />
                    <span className="text-[12px] 2xl:text-[13px] font-semibold uppercase tracking-[0.14em] text-[#C01718]">
                      Persönlich für Sie
                    </span>
                  ...
                  {/* Main Heading */}
                  <h2 className="mb-2.5 sm:mb-4 font-display text-2xl sm:text-3xl lg:text-[36px] xl:text-[40px] 2xl:text-[46px] font-normal leading-[1.14] tracking-tight text-[#1A1A1A] relative z-10">
