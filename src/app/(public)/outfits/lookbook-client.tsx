...
export function OutfitsLookbook({
  ...
  const filteredOutfits = useMemo(() => {
    return initialOutfits.filter(outfit => {
      // For EVERY group that has at least 1 selected filter,
      // the outfit MUST have at least 1 category that matches ONE of those selected filters.
  ...
  return (
    <div className="lookbook-layout">
      ...
      <div className="mobile-filter-bar">
        ...
        >
          {mobileFilterOpen ? "Filter schließen" : "Outfits filtern"}
      ...
      <div className="lookbook-container">
        ...
        <aside className={`lookbook-sidebar ${mobileFilterOpen ? "open" : ""}`}>
