      ...
      <div class="container narken-info">
        <div class="row ">
          <div class="col-md-6 first-row">
            <h2>Sorgenfri</h2>
            <p>Das dänische Label Sorgenfri steht für zeitlose Eleganz und skandinavische Lässigkeit. Die Kollektionen überzeugen durch klare Linien, hochwertige Materialien und eine perfekte Passform. Sorgenfri bietet eine große Auswahl an Blazern, Hosen, Blusen und Kleidern, die sich perfekt miteinander kombinieren lassen. Die Marke setzt auf nachhaltige Produktionsbedingungen und achtet auf umweltfreundliche Herstellungsprozesse. Sorgenfri ist die ideale Wahl für Frauen, die Wert auf zeitlose Mode mit skandinavischem Design legen.</p>
          </div>
          <div class="col-md-6">
            <img src="/src/img/sorgenfri.jpg" class="img-fluid image" alt="Zilch">
          </div>
        </div>
      </div>
    </section>
