      ...
      <div class="container narken-info">
        <div class="row ">
          <div class="col-md-6 first-row">
            <h2>Madness</h2>
            <p>Das italienische Label Madness steht für zeitlose Eleganz und italienische Lässigkeit. Die Kollektionen überzeugen durch klare Linien, hochwertige Materialien und eine perfekte Passform. Madness bietet eine große Auswahl an Blazern, Hosen, Blusen und Kleidern, die sich perfekt miteinander kombinieren lassen. Die Marke setzt auf nachhaltige Produktionsbedingungen und achtet auf umweltfreundliche Herstellungsprozesse. Madness ist die ideale Wahl für Frauen, die Wert auf zeitlose Mode mit italienischem Design legen.</p>
          </div>
          <div class="col-md-6">
            <img src="/src/img/madness.jpg" class="img-fluid image" alt="Zilch">
          </div>
        </div>
      </div>
    </section>
