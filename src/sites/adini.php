      ...
      <div class="container narken-info">
        <div class="row ">
          <div class="col-md-6 first-row">
            <h2>Adini</h2>
            <p>Das britische Label Adini steht für feminine Mode mit einem Hauch von Boho-Chic. Die Kollektionen überzeugen durch romantische Designs, verspielte Details und hochwertige Materialien. Adini bietet eine große Auswahl an Kleidern, Röcken, Blusen und Tuniken, die sich perfekt miteinander kombinieren lassen. Die Marke setzt auf faire Produktionsbedingungen und achtet auf umweltfreundliche Herstellungsprozesse. Adini ist die ideale Wahl für Frauen, die Wert auf feminine Mode mit romantischen Details legen.</p>
          </div>
          <div class="col-md-6">
            <img src="/src/img/2024-2_adini.jpg" class="img-fluid image" alt="Zilch">
          </div>
        </div>
      </div>
    </section>
