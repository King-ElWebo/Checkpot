      ...
      <div class="container narken-info">
        <div class="row ">
          <div class="col-md-6 first-row">
            <h2>Angels</h2>
            <p>Angels ist eine deutsche Modemarke, die sich auf Damenmode spezialisiert hat. Die Kollektionen von Angels zeichnen sich durch hochwertige Materialien, eine exzellente Verarbeitung und eine perfekte Passform aus. Die Marke bietet eine große Auswahl an Hosen, Jeans, Blusen und Shirts, die sich durch zeitlose Eleganz und hohe Qualität auszeichnen. Angels legt großen Wert auf Nachhaltigkeit und setzt auf umweltfreundliche Herstellungsprozesse. Die Marke ist die ideale Wahl für Frauen, die Wert auf stilvolle und hochwertige Mode legen.</p>
          </div>
          <div class="col-md-6">
            <img src="/src/img/angels.jpg" class="img-fluid image" alt="Zilch">
          </div>
        </div>
      </div>
    </section>
