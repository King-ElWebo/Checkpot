      ...
      <div class="container narken-info">
        <div class="row ">
          <div class="col-md-6 first-row">
            <h2>Kinglouie</h2>
            <p>Das österreichische Label Kinglouie steht für nachhaltige Mode, die durch ihre fröhlichen Farben und Muster besticht. Die Kollektionen sind aus hochwertigen Materialien gefertigt und überzeugen durch ihre Langlebigkeit. Kingluiie bietet eine große Auswahl an Kleidern, Röcken, Blusen und Hosen, die sich perfekt miteinander kombinieren lassen. Die Marke setzt auf faire Produktionsbedingungen und achtet auf umweltfreundliche Herstellungsprozesse. Kinglouie ist die ideale Wahl für Frauen, die Wert auf nachhaltige Mode mit femininem Design legen.</p>
          </div>
          <div class="col-md-6">
            <img src="/src/img/kinglouie.jpg" class="img-fluid image" alt="Zilch">
          </div>
        </div>
      </div>
    </section>
