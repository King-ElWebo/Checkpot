...
export function Footer({ storeDetails }: { storeDetails: StoreDetails }) {
  ...
  return (
    <footer className="border-t border-[#E5E2DC] bg-[#F9F9F8] text-[#1A1A1A]">
      <div className="mx-auto max-w-[1400px] 2xl:max-w-[1600px] px-6 lg:px-8 2xl:px-12 pt-14 lg:pt-18 pb-8 lg:pb-10">
        ...
        {/* Bottom Meta Row */}
        <div className="mt-12 lg:mt-14 pt-6 border-t border-[#E5E2DC] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-[13px] text-[#718096]">
          <p>
