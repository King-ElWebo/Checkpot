...
| Outfit-Titel | Sort | Kollektion | Bild vorhanden | Zugeordnete Marken | Filter-Kategorien | Redaktioneller Handlungsbedarf |
|---|---|---|---|---|---|---|
| **Musterkleid Sommer** | 10 | Frühjahr / Sommer | Ja | `Zilch` *(Legacy-Marke)* | Frühling/Sommer, Feminin, Muster | Reale Marke bei nächstem Lookbook-Update zuweisen |
| **Blauer Winter Look** | 20 | Herbst / Winter | Ja | `Sorgenfri` | Herbst/Winter, Klassisch, Kräftige Farben | Kanonischer Winter-Look |
| **Outfit 1: Autumn Layer** | 30 | Herbst / Winter | Ja | *(Keine)* | Herbst/Winter, Lässig, Naturtöne | Reale Marke(n) zuweisen |
| **Outfit 2: Blue Summer** | 40 | Frühlingserwachen | Ja | *(Keine)* | Frühling/Sommer, Lässig, Kräftige Farben | Reale Marke(n) zuweisen |
